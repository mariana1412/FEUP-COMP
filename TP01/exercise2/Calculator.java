...
public class Calculator/*@bgen(jjtree)*/implements CalculatorTreeConstants, CalculatorConstants {/*@bgen(jjtree)*/
  protected static JJTCalculatorState jjtree = new JJTCalculatorState();public static HashMap<String, Integer> vars = new HashMap<String, Integer>();
...
if (jjtc000) {
  ...
  static final public void Assignment() throws ParseException {Token symbol, value;
    ...
    if (jj_2_4(2)) {
      if (jj_2_2(2)) {
        ...
        jj_consume_token(END);
vars.put(symbol.image, Integer.parseInt(value.image));
      } else if (jj_2_3(2)) {
...
jjtree.closeNodeScope(jjtn002, true);
                     jjtc002 = false;
jjtn002.val = sign * vars.get(t.image);
      } finally {
if (jjtc002) {
                       jjtree.closeNodeScope(jjtn002, true);
                     }
